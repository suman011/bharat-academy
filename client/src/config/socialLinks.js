...
export function getFooterSocialLinks() {
  return [
    { id: "facebook", label: "Facebook", href: env("VITE_SOCIAL_FACEBOOK") || FALLBACK_HREF, Icon: FaFacebookF },
    ...
    { id: "instagram", label: "Instagram", href: env("VITE_SOCIAL_INSTAGRAM") || FALLBACK_HREF, Icon: FaInstagram },
  ];
}
