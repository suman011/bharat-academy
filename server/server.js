...
const FINAL_TEST_BANK = {
  ...
  "mathematics-for-ai-machine-learning": {
    quizTitle: "Mathematics for AI & Machine Learning – MCQs",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      {
        ...
        options: ["Fixed value", "Changing value", "Constant value", "Output value"],
        answer: 1,
      },
      {
        id: 2,
        question: "What is a function?",
        options: ["Random value", "Relationship between input and output", "Only input", "Only output"],
        answer: 1,
      },
      {
        id: 3,
        question: "What is a linear equation?",
        options: ["Curve", "Straight line equation", "Random graph", "Circular graph"],
        answer: 1,
      },
      {
        id: 4,
        question: "What does slope (m) represent in y = mx + c?",
        options: ["Output", "Input", "Rate of change", "Constant"],
        answer: 2,
      },
      {
        id: 5,
        question: "What is a vector?",
        options: ["Single number", "Collection of numbers", "Function", "Graph"],
        answer: 1,
      },
      {
        id: 6,
        question: "What is a matrix?",
        options: ["Single value", "1D array", "2D array of numbers", "Function"],
        answer: 2,
      },
      {
        id: 7,
        question: "What is the dot product used for?",
        options: ["Sorting data", "Combining vectors", "Printing data", "Storing data"],
        answer: 1,
      },
      {
        id: 8,
        question: "What is the derivative?",
        options: ["Sum", "Product", "Rate of change", "Division"],
        answer: 2,
      },
      {
        id: 9,
        question: "What is gradient descent used for?",
        options: ["Increase error", "Minimize error", "Store data", "Sort data"],
        answer: 1,
      },
      {
        id: 10,
        question: "What is a cost function?",
        options: ["Data storage", "Measures model error", "Input variable", "Output variable"],
        answer: 1,
      },
      {
        id: 11,
        question: "What is Mean Squared Error (MSE)?",
        options: ["Sum of errors", "Average squared error", "Maximum error", "Minimum error"],
        answer: 1,
      },
      {
        id: 12,
        question: "What is probability?",
        options: ["Fixed outcome", "Likelihood of an event", "Input value", "Output value"],
        answer: 1,
      },
      {
        id: 13,
      ...
      },
      {
        ...
        options: ["Probability without condition", "Probability given a condition", "Random probability", "Fixed probability"],
        answer: 1,
      },
      {
        id: 15,
        question: "What is Bayes Theorem used for?",
        options: ["Sorting", "Updating probability", "Printing", "Storing"],
        answer: 1,
      },
      {
        id: 16,
        question: "What is a normal distribution?",
        options: ["Random shape", "Bell-shaped curve", "Straight line", "Triangle"],
        answer: 1,
      },
      {
        id: 17,
        question: "What does mean represent?",
        options: ["Spread", "Average", "Maximum", "Minimum"],
        answer: 1,
      },
      {
        id: 18,
        question: "What does standard deviation represent?",
        options: ["Average", "Spread of data", "Sum", "Product"],
        answer: 1,
      },
      {
        id: 19,
        question: "What is the goal of calculus in ML?",
        options: ["Data storage", "Optimization", "Printing", "Sorting"],
        answer: 1,
      },
      {
        id: 20,
        question: "What is the main goal of ML mathematics?",
        options: ["Increase complexity", "Optimize models", "Store data", "Reduce data"],
        answer: 1,
      },
    ],
  },
