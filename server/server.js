...
const FINAL_TEST_BANK = {
  ...
  "introduction-to-machine-learning": {
    quizTitle: "Introduction to Machine Learning – MCQs",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      {
        ...
        options: ["Writing code manually", "Learning patterns from data", "Hardware design", "Networking"],
        answer: 1,
      },
      {
        id: 2,
        question: "Which of the following is a type of ML?",
      ...
      },
      {
        ...
        options: ["No data", "Learning without labels", "Learning with labeled data", "Random learning"],
        answer: 2,
      },
      {
        id: 4,
        question: "What is unsupervised learning?",
        options: ["Learning with labels", "Learning without labels", "Manual learning", "Fixed learning"],
        answer: 1,
      },
      {
        id: 5,
        question: "What is reinforcement learning?",
        options: ["Learning from books", "Learning by trial and error", "Learning without data", "Learning from labels"],
        answer: 1,
      },
      {
        id: 6,
        question: "Which is an example of supervised learning?",
        options: ["Clustering", "Classification", "Grouping", "Association"],
        answer: 1,
      },
      {
        id: 7,
      ...
      },
      {
        ...
        options: ["Predicting categories", "Predicting numbers", "Grouping data", "Random prediction"],
        answer: 1,
      },
      {
        id: 9,
        question: "What is classification?",
        options: ["Predicting numbers", "Grouping randomly", "Predicting categories", "Sorting only"],
        answer: 2,
      },
      {
        id: 10,
        question: "What is a dataset?",
        options: ["Single value", "Collection of data", "Algorithm", "Model"],
        answer: 1,
      },
      {
        id: 11,
        question: "What are features?",
        options: ["Output values", "Input variables", "Model weights", "Predictions"],
        answer: 1,
      },
      {
        id: 12,
        question: "What is a model in ML?",
        options: ["Data storage", "Mathematical function", "Hardware", "Code editor"],
        answer: 1,
      },
      {
        id: 13,
        question: "What is training in ML?",
        options: ["Writing code", "Learning from data", "Testing model", "Deploying model"],
        answer: 1,
      },
      {
        id: 14,
        question: "What is testing in ML?",
        options: ["Learning", "Evaluating model performance", "Coding", "Training data"],
        answer: 1,
      },
      {
        id: 15,
        question: "What is overfitting?",
        options: ["Model too simple", "Model learns noise", "Model ignores data", "Model fails completely"],
        answer: 1,
      },
      {
        id: 16,
        question: "What is underfitting?",
        options: ["Model too complex", "Model too simple", "Model perfect", "Model optimized"],
        answer: 1,
      },
      {
        id: 17,
        question: "What is accuracy?",
        options: ["Error", "Correct predictions percentage", "Data size", "Feature value"],
        answer: 1,
      },
      {
        id: 18,
        question: "What is a training set?",
        options: ["Testing data", "Data used to train model", "Output data", "Random data"],
        answer: 1,
      },
      {
        id: 19,
        question: "What is a test set?",
        options: ["Training data", "Data to evaluate model", "Input data", "Feature data"],
        answer: 1,
      },
      {
        id: 20,
        question: "What is the goal of Machine Learning?",
        options: ["Increase errors", "Predict accurately", "Reduce data", "Remove features"],
        answer: 1,
      },
    ],
  },
