...
const FINAL_TEST_BANK = {
  ...
  "python-for-ai-beginner-level": {
    quizTitle: "Python for AI – Beginner Level - Final Test",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      {
        id: 1,
        question: "What is Python mainly used for in AI?",
        options: ["Web designing", "Data analysis & ML", "Hardware design", "Networking"],
        answer: 1,
      },
      {
        id: 2,
        question: "Which library is used for numerical computations?",
      ...
      },
      {
        ...
        options: ["int x = 10", "x = 10", "var x = 10", "declare x = 10"],
        answer: 1,
      },
      { id: 6, question: "Which data type is used for decimal numbers?", options: ["int", "str", "float", "bool"], answer: 2 },
      { id: 7, question: "What is the output of: type(10)?", options: ["float", "str", "int", "bool"], answer: 2 },
      {
        id: 8,
        question: "Which structure is used to store multiple values?",
        options: ["Variable", "Function", "List", "Loop"],
        answer: 2,
      },
      { id: 9, question: "How do you define a list?", options: ["{}", "()", "[]", "<>"], answer: 2 },
      {
        id: 10,
      ...
      { id: 11, question: "Which keyword is used for decision making?", options: ["loop", "if", "case", "switch"], answer: 1 },
      {
        id: 12,
        question: "What does len() function do?",
        options: ["Calculates sum", "Counts elements", "Sorts data", "Filters data"],
        answer: 1,
      },
      {
        id: 13,
      ...
      },
      {
        ...
        options: ["Single value", "Table-like structure", "Loop", "Function"],
        answer: 1,
      },
      {
        id: 15,
        question: "Which function reads a CSV file?",
        options: ["open()", "read()", "pd.read_csv()", "csv.load()"],
        answer: 2,
      },
      {
        id: 16,
      ...
      },
      {
        ...
        options: ["Save graph", "Display graph", "Delete graph", "Edit graph"],
        answer: 1,
      },
      { id: 18, question: "Which operator is used for equality check?", options: ["=", "==", "===", "!="], answer: 1 },
      { id: 19, question: "What is the output of: 3 + 2 * 2?", options: ["10", "7", "8", "6"], answer: 1 },
      {
        id: 20,
        question: "What is Machine Learning in Python?",
        options: ["Writing HTML", "Data storage", "Learning patterns from data", "Image editing"],
        answer: 2,
      },
    ],
  },
  "introduction-to-automation-and-robotics": {
    quizTitle: "Introduction to Automation and Robotics - Final Assessment",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      { id: 1, question: "Industry 4.0 primarily emphasizes?", options: ["Paper ledgers", "Digital connectivity and data-driven operations", "Manual-only assembly", "Eliminating all software"], answer: 1 },
      { id: 2, question: "A smart factory typically improves?", options: ["Only marketing", "Visibility, quality, and traceability on the shop floor", "Only HR policies", "Only office Wi-Fi"], answer: 1 },
      { id: 3, question: "MES in manufacturing context usually refers to?", options: ["Manufacturing Execution System", "Marketing Email Service", "Mobile Encryption Standard", "Material Estimation Sheet"], answer: 0 },
      { id: 4, question: "OT vs IT awareness means?", options: ["Ignoring plant networks", "Recognizing different risk and uptime needs between plant and office systems", "Merging passwords blindly", "Disabling firewalls"], answer: 1 },
      { id: 5, question: "A PLC is best described as?", options: ["A spreadsheet template", "A rugged controller for logic and sequencing in industrial environments", "A consumer laptop", "Only a sensor"], answer: 1 },
      { id: 6, question: "SCADA systems are commonly used for?", options: ["Word processing", "Supervision, monitoring, and control of processes", "Social media", "Image editing"], answer: 1 },
      { id: 7, question: "IIoT stands for?", options: ["Internal Internet of Things", "Industrial Internet of Things", "Integrated Input Output Table", "International Import Order Tracking"], answer: 1 },
      { id: 8, question: "A digital twin is typically?", options: ["A paper duplicate", "A virtual model aligned with a physical asset or process", "A backup hard drive only", "A marketing brochure"], answer: 1 },
      { id: 9, question: "KPI thinking on the shop floor focuses on?", options: ["Random opinions", "Measurable performance indicators tied to production goals", "Only employee birthdays", "Only logo colors"], answer: 1 },
      { id: 10, question: "Cyber-physical systems combine?", options: ["Only hardware", "Physical processes with computation, communication, and control", "Only spreadsheets", "Only HR forms"], answer: 1 },
      { id: 11, question: "Change management in automation projects helps with?", options: ["Skipping training", "People, process, and adoption risks during rollout", "Deleting documentation", "Removing safety reviews"], answer: 1 },
      { id: 12, question: "A common goal of automation is to?", options: ["Remove all humans always", "Improve consistency, safety, and throughput with clear roles", "Stop all maintenance", "Eliminate data logging"], answer: 1 },
    ],
  },
  "industrial-safety-standards": {
    quizTitle: "Industrial Safety and Standards - Final Assessment",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      { id: 1, question: "PPE stands for?", options: ["Personal Protective Equipment", "Plant Process Engineering", "Production Planning Estimate", "Power Protection Extension"], answer: 0 },
      { id: 2, question: "LOTO primarily prevents?", options: ["Data leaks", "Unexpected energization during maintenance", "Slow internet", "Printer jams"], answer: 1 },
      { id: 3, question: "A Permit to Work (PTW) is used to?", options: ["Authorize controlled hazardous work with documented controls", "Approve vacation", "Order stationery", "Schedule marketing"], answer: 0 },
      { id: 4, question: "Hierarchy of controls places elimination at?", options: ["The bottom", "The top (most effective)", "Outside the hierarchy", "Equal to PPE only"], answer: 1 },
      { id: 5, question: "HAZOP is commonly used for?", options: ["Payroll", "Systematic hazard and operability study", "Logo design", "Tax filing"], answer: 1 },
      { id: 6, question: "Electrical safety basics include?", options: ["Working live without training", "Qualified persons, isolation, and verification", "Using wet gloves intentionally", "Bypassing grounds"], answer: 1 },
      { id: 7, question: "Confined space work typically requires?", options: ["No planning", "Atmosphere checks, rescue planning, and permits", "Only a helmet", "Music playlists"], answer: 1 },
      { id: 8, question: "Incident investigation aims to?", options: ["Blame individuals only", "Find root causes and prevent recurrence", "Hide evidence", "Speed up without learning"], answer: 1 },
      { id: 9, question: "Machine guarding helps prevent?", options: ["Good lighting", "Contact with moving parts and pinch points", "Coffee spills in office", "Slow Wi-Fi"], answer: 1 },
      { id: 10, question: "Safety culture is strengthened by?", options: ["Ignoring near misses", "Leadership commitment and reporting without fear", "Deleting audits", "Skipping training"], answer: 1 },
      { id: 11, question: "Fire emergency response planning should include?", options: ["Only posters", "Alarms, evacuation routes, roles, and drills", "Deleting extinguishers", "Ignoring alarms"], answer: 1 },
      { id: 12, question: "A Safety Management System (SMS) supports?", options: ["Random work", "Structured policy, risk control, and continuous improvement", "Only sales targets", "Only branding"], answer: 1 },
    ],
  },
  "introduction-to-machine-learning": {
    quizTitle: "Introduction to Machine Learning - Final Assessment",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      { id: 1, question: "Machine learning models learn from?", options: ["Only hardware speed", "Data", "Printer settings", "Monitor brightness"], answer: 1 },
      { id: 2, question: "Supervised learning needs?", options: ["No inputs", "Labeled examples", "Only images without labels", "Random noise only"], answer: 1 },
      { id: 3, question: "Train/test split helps to?", options: ["Guarantee infinite accuracy", "Estimate performance on unseen data", "Remove all features", "Skip evaluation"], answer: 1 },
      { id: 4, question: "Overfitting means the model?", options: ["Fails on training data", "Memorizes training noise and may generalize poorly", "Always ignores labels", "Cannot use numbers"], answer: 1 },
      { id: 5, question: "Linear regression predicts?", options: ["Categories only", "A continuous numeric target", "Only text tokens", "Only audio"], answer: 1 },
      { id: 6, question: "Logistic regression is commonly used for?", options: ["Regression of house prices only", "Classification problems", "Sorting files on disk", "Database backups"], answer: 1 },
      { id: 7, question: "A confusion matrix summarizes?", options: ["Network topology", "Classification errors across classes", "CPU temperature only", "Git branches"], answer: 1 },
      { id: 8, question: "Feature engineering is about?", options: ["Deleting all data", "Creating useful inputs from raw data", "Changing monitor resolution", "Renaming folders only"], answer: 1 },
      { id: 9, question: "Cross-validation can help?", options: ["Reduce need for any data", "Stabilize performance estimates across splits", "Remove labels", "Guarantee deployment"], answer: 1 },
      { id: 10, question: "Precision focuses on?", options: ["All positives found", "How many predicted positives are truly positive", "Training loss only", "Dataset file size"], answer: 1 },
      { id: 11, question: "Recall focuses on?", options: ["How many actual positives are found", "Only false positives", "Learning rate schedules only", "IDE theme"], answer: 0 },
      { id: 12, question: "A baseline model is useful to?", options: ["Replace data collection", "Compare improvements against a simple reference", "Skip evaluation", "Remove test sets"], answer: 1 },
    ],
  },
  "mathematics-for-ai-machine-learning": {
    quizTitle: "Mathematics for AI and Machine Learning - Final Assessment",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      { id: 1, question: "A vector in ML often represents?", options: ["A single scalar only", "An ordered list of numbers (features)", "A calendar date only", "A printer driver"], answer: 1 },
      { id: 2, question: "The dot product of two vectors relates to?", options: ["Only string concatenation", "Similarity/projection along a direction", "File compression", "DNS lookup"], answer: 1 },
      { id: 3, question: "A matrix commonly stores?", options: ["One number only", "Tabular data such as samples by features", "Only audio waveforms uncompressed", "Only IP addresses"], answer: 1 },
      { id: 4, question: "Matrix multiplication is central in ML because?", options: ["It is decorative", "It composes linear transformations used in layers and projections", "It replaces databases", "It removes gradients"], answer: 1 },
      { id: 5, question: "The transpose of a matrix can help with?", options: ["Changing shape/layout for valid operations", "Deleting all weights", "Removing learning", "Stopping GPUs"], answer: 0 },
      { id: 6, question: "A derivative measures?", options: ["Only area", "Rate of change of a function", "Only volume", "Only probability mass"], answer: 1 },
      { id: 7, question: "Gradient descent uses gradients to?", options: ["Increase loss on purpose", "Update parameters to reduce a loss function", "Shuffle labels randomly", "Remove datasets"], answer: 1 },
      { id: 8, question: "A cost function in training typically measures?", options: ["Monitor brightness", "How wrong predictions are vs targets", "Wi-Fi speed", "Folder color"], answer: 1 },
      { id: 9, question: "Probability of an event is between?", options: ["-1 and -2", "0 and 1", "2 and 3", "10 and 20"], answer: 1 },
      { id: 10, question: "Conditional probability P(A|B) means?", options: ["A always equals B", "Probability of A given B is true", "A is impossible", "B is unrelated"], answer: 1 },
      { id: 11, question: "Bayes' theorem helps with?", options: ["Updating beliefs from evidence", "Sorting pixels alphabetically", "Removing matrices", "Disabling calculus"], answer: 0 },
      { id: 12, question: "The normal distribution is useful because many features/errors are?", options: ["Always constants", "Approximately bell-shaped in aggregate", "Always zero", "Never random"], answer: 1 },
    ],
  },
};
