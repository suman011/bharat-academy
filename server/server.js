...
const FINAL_TEST_BANK = {
  ...
  "industrial-safety-standards": {
    quizTitle: "Industrial Safety & Standards – MCQs",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      {
        id: 1,
        question: "What is industrial safety?",
        options: ["Increasing production", "Protecting workers and workplace", "Reducing cost", "Managing machines"],
        answer: 1,
      },
      {
        id: 2,
      ...
      {
        id: 3,
        question: "Which of the following is PPE?",
        options: ["Helmet", "Gloves", "Safety shoes", "All of the above"],
        answer: 3,
      },
      {
        id: 4,
        question: "What is the purpose of a safety helmet?",
        options: ["Style", "Protect head from injury", "Reduce noise", "Improve vision"],
        answer: 1,
      },
      {
        id: 5,
        question: "What does a fire extinguisher do?",
        options: ["Creates fire", "Detects fire", "Controls or extinguishes fire", "Produces smoke"],
        answer: 2,
      },
      {
        id: 6,
        question: "What is a hazard?",
        options: ["Safe condition", "Potential source of harm", "Tool", "Machine"],
        answer: 1,
      },
      {
        id: 7,
        question: "What is a risk?",
        options: ["Hazard itself", "Chance of harm occurring", "Safety rule", "Equipment"],
        answer: 1,
      },
      {
        id: 8,
        question: "Which sign indicates danger?",
        options: ["Green", "Blue", "Red", "Yellow"],
        answer: 2,
      },
      {
        id: 9,
        question: "What is the color for warning signs?",
      ...
      },
      {
        ...
        options: [
          ...
          "Internal Safety Order",
        ],
        answer: 1,
      },
      {
        id: 11,
        question: "What is OSHA related to?",
        options: ["Education", "Safety regulations", "Finance", "Marketing"],
        answer: 1,
      },
      {
        id: 12,
        question: "What is a safety audit?",
        options: ["Machine repair", "Checking safety practices", "Hiring employees", "Buying equipment"],
        answer: 1,
      },
      {
        id: 13,
        question: "What is the purpose of safety training?",
        options: ["Increase workload", "Improve safety awareness", "Reduce salary", "Delay work"],
        answer: 1,
      },
      {
        id: 14,
        question: "What should you do in case of fire?",
        options: ["Panic", "Run randomly", "Follow emergency procedure", "Ignore"],
        answer: 2,
      },
      {
        id: 15,
        ...
        options: [
          "Machine operation",
          "Safety procedure to control hazardous energy",
          "Cleaning process",
          "Storage method",
        ],
        answer: 1,
      ...
      {
        id: 16,
        question: "What is the use of safety shoes?",
        options: ["Style", "Protect feet from injury", "Improve speed", "Reduce noise"],
        answer: 1,
      },
      {
        id: 17,
        question: "What is an emergency exit?",
        options: ["Entry point", "Exit during emergency", "Storage area", "Workstation"],
        answer: 1,
      },
      {
        id: 18,
        ...
        options: [
          "Machine design",
          "Designing workplace for comfort and safety",
          "Safety rules",
          "Fire control",
        ],
        answer: 1,
      ...
      {
        id: 19,
        question: "What is the purpose of safety signs?",
        options: ["Decoration", "Provide information and warnings", "Increase cost", "Reduce space"],
        answer: 1,
      },
      {
        id: 20,
        question: "What is the main goal of safety standards?",
        options: ["Increase production only", "Reduce cost", "Ensure safe working environment", "Increase machine speed"],
        answer: 2,
      },
    ],
  },
