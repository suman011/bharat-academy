...
const FINAL_TEST_BANK = {
  ...
  "introduction-to-automation-and-robotics": {
    quizTitle: "Introduction to Automation & Robotics – MCQs",
    passPercentage: 70,
    maxAttempts: 3,
    durationSec: 15 * 60,
    questions: [
      {
        ...
        options: ["Manual work", "Work done by machines with minimal human effort", "Only software development", "Only robotics"],
        answer: 1,
      },
      {
        id: 2,
        question: "What is a Robot?",
        options: ["Human worker", "Machine capable of performing tasks automatically", "Software tool", "Computer program only"],
        answer: 1,
      },
      {
        id: 3,
        question: "Which of the following is NOT a component of a robot?",
        options: ["Sensors", "Actuators", "CPU", "Printer"],
        answer: 3,
      },
      {
        id: 4,
        question: "What is the function of sensors in robotics?",
        options: ["Perform movement", "Detect environment", "Store data", "Print output"],
        answer: 1,
      },
      {
        id: 5,
        question: "What do actuators do?",
        options: ["Sense data", "Process data", "Create movement/action", "Store memory"],
        answer: 2,
      },
      {
        id: 6,
        question: "Which type of robot is used in industries?",
        options: ["Domestic robot", "Industrial robot", "Medical robot", "Educational robot"],
        answer: 1,
      },
      {
        id: 7,
        question: "What is PLC in automation?",
        options: ["Personal Laptop Computer", "Programmable Logic Controller", "Power Line Control", "Process Logic Code"],
        answer: 1,
      },
      {
        id: 8,
        question: "What is the main goal of automation?",
        options: ["Increase manual work", "Reduce efficiency", "Improve productivity and accuracy", "Increase errors"],
        answer: 2,
      },
      {
        id: 9,
        question: "Which industry uses robots the most?",
        options: ["Agriculture", "Manufacturing", "Education", "Tourism"],
        answer: 1,
      },
      {
        id: 10,
        question: "What is Artificial Intelligence (AI) in robotics?",
        options: ["Manual control", "Ability of robots to think and learn", "Hardware design", "Mechanical process"],
        answer: 1,
      },
      {
        id: 11,
        question: "What is a collaborative robot (cobot)?",
        options: ["Works alone", "Works with humans", "Works only at night", "Works remotely"],
        answer: 1,
      },
      {
        id: 12,
        question: "Which robot is used at home?",
        options: ["Industrial robot", "Domestic robot", "Military robot", "Space robot"],
        answer: 1,
      },
      {
        id: 13,
        question: "What is the use of automation in manufacturing?",
        options: ["Increase errors", "Reduce production", "Improve efficiency and consistency", "Stop production"],
        answer: 2,
      },
      {
        id: 14,
        question: "What is a control system?",
        options: ["System that manages robot actions", "Storage system", "Sensor system", "Mechanical system only"],
        answer: 0,
      },
      {
        id: 15,
        question: "What is IoT in automation?",
        options: ["Internet of Things", "Internal Operating Tool", "Intelligent Object Tracking", "Integrated Output Technology"],
        answer: 0,
      },
      {
        id: 16,
        question: "What is the advantage of robots?",
        options: ["Get tired easily", "Work slowly", "High precision and repeatability", "Make more mistakes"],
        answer: 2,
      },
      {
        id: 17,
        question: "What is the disadvantage of automation?",
        options: ["High productivity", "High initial cost", "Accuracy", "Speed"],
        answer: 1,
      },
      {
        id: 18,
        question: "Which robot is used in healthcare?",
        options: ["Industrial robot", "Medical robot", "Agricultural robot", "Military robot"],
        answer: 1,
      },
      {
        id: 19,
        question: "What is a robotic arm?",
        options: ["Human arm", "Mechanical arm used for tasks", "Sensor device", "Software program"],
        answer: 1,
      },
      {
        id: 20,
        question: "What is Industry 4.0?",
        options: ["Traditional industry", "Manual production", "Smart manufacturing with automation and data", "Only robotics"],
        answer: 2,
      },
    ],
  },
